...
// const testBadge = {
//   name: "Starter",
//   desc: "You started your journey, every small step counts.",
// };
...
//       <div className="badge-modal-content">
//       <div className="badge-icon">
//           <img src={Starter} alt={badge.name} className="badge-modal-img" />
//         </div>
...
//   if (!open) return null; // لو مش مفتوح ميظهرش خالص
...
//         <div className="user-info">
//           <p>
//             <strong>Total Points:</strong> 250
//           </p>
//           <p>
...
//         <div className="badges">
//           <div className="badge" onClick={() => setShowBadge(true)}>
//             <Award size={28} />
//           </div>
//           <div className="badge">
//             <Award size={28} />
...
//       {showBadge && (
//         <BadgeModal badge={testBadge} onClose={() => setShowBadge(false)} />
//       )}
//     </>
//   );
// };
